...
def add_references(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        col("record_id"), 
        ...
        col("date_specimen"), 
        col("diagnosis_code"), 
        lookup("ref_diagnosis", col("diagnosis_code")).getField("diag_desc_short").alias("diagnosis_description"), 
        col("procedure_code"), 
        col("loinc_code"), 
        lookup("ref_loinc", col("loinc_code")).getField("component").alias("loinc_component"), 
        col("test_ordered_name"), 
        col("test_result_value"), 
        col("test_result_name"), 
        col("test_result_comments"), 
        col("date_report"), 
        col("time_report"), 
        col("lab_id"), 
        col("lab_test_id"), 
        ...
        col("ordering_state"), 
        col("ordering_zip"), 
        lookup("ref_diagnosis", col("diagnosis_code")).getField("diag_is_rare").alias("is_rare_diagnosis"), 
